...
DROP POLICY IF EXISTS "Users can delete own wallet balances" ON wallet_balances;
...
CREATE POLICY "Users can delete own wallet balances" ON wallet_balances FOR DELETE USING (auth.uid() = user_id);
